...
class Additional_Details_Meta_Box {
	...
	public function register_admin_scripts() {
		...
		wp_enqueue_script( 'inspiry-admin-metabox-script', get_template_directory_uri() . '/framework/include/admin/inspiry-admin-metabox.js', array(
			'jquery',
			'jquery-ui-sortable',
		), '1.0' );
	...
	public function add_additional_details_metabox() {
		...
		add_meta_box( 'additional-details-meta-box', __( 'Additional Details', 'framework' ), array(
			$this,
