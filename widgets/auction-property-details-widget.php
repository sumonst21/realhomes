<?php
/**
 * Widget: Auction Property Details Widget
 *
 * @since 3.0.0
 * @package RH/modern
 */

if ( ! class_exists( 'Auction_Property_Details_Widget' ) ) {

	/**
	 * Auction_Property_Details_Widget.
	 *
	 * Widget of auction property details.
	 *
	 * @since 3.0.0
	 */
	class Auction_Property_Details_Widget extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array(
				'classname' => 'Auction_Property_Details_Widget',
				'description' => __( 'Displays Auction Property Details.', 'framework' ),
				'customize_selective_refresh' => true,
			);
			parent::__construct(
				'Auction_Property_Details_Widget',
				__( 'Auction Property Details', 'framework' ),
				$widget_ops
			);
		}
		...
		function widget( $args, $instance ) {
			...
			$featured_args = array(
				...
				'meta_query' => array(
					array(
						'key' => 'REAL_HOMES_auction_enabled',
						'value' => 1,
						'compare' => '=',
						'type'  => 'NUMERIC',
					),
		...
		function form( $instance ) {
			$instance = wp_parse_args(
				(array) $instance, array(
					'title' => 'Auction Property Details',
					'count' => 1,
					//'sort_by' => 'random',
				)
			);
